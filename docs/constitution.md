...
> **Archived** (2026-09-24): the speckit workflow references in §"Marquis Milestone Workflow / Quality Gates" (specs/ dir, `/speckit.plan`) are superseded by OpenSpec (`openspec/`, `/opsx-*` commands). The principles remain in force — `AGENTS.md` is authoritative.
