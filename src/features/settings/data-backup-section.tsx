      ...
      >
        <DialogContent data-testid="settings-backup-dialog">
          <DialogHeader>
            ...
            <DialogDescription>
              This replaces every current cycle, day record, and setting on this device. It cannot
              be undone.
            </DialogDescription>
          </DialogHeader>
          {prepared ? (
            <div className="space-y-2 text-sm" data-testid="settings-backup-summary">
              <p>
                Backup app version {prepared.summary.appVersion}; exported{" "}
                {prepared.summary.exportedAt}.
              </p>
              <p>
          ...
          <div className="flex items-start gap-2">
            ...
            />
            <Label htmlFor="settings-backup-ack">
          ...
          <DialogFooter>
            ...
            <Button
              type="button"
              variant="outline"
              data-testid="settings-backup-cancel"
              onClick={closeDialog}
            >
              Cancel
            </Button>
